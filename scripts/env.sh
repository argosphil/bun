...
export CFLAGS='-O3 -g3 -gdwarf-4 -fno-exceptions -fvisibility=hidden -fvisibility-inlines-hidden'
export CXXFLAGS='-O3 -g3 -gdwarf-4  -fno-exceptions -fvisibility=hidden -fvisibility-inlines-hidden'
