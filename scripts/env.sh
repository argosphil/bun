...
export CFLAGS='-fno-exceptions -fvisibility=hidden -fvisibility-inlines-hidden'
export CXXFLAGS='-fno-exceptions -fvisibility=hidden -fvisibility-inlines-hidden'
